...
/**
 * Legacy route: customer “subscription” is now an optional identity-verification add-on only.
 * Core customer access (profile, reviews, responses, disputes) is free — use customer-paywall for the add-on.
 */
